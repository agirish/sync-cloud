...
|---|---|---|---|
| `main` | the **v4 line** — where the next release is built | `4.4-dev` / `404` | **allowed** |
...
CFBundleShortVersionString: "4.4-dev"   # the marketing version — what people see
CFBundleVersion: "404"                  # the build number — what Launch Services orders by
```
