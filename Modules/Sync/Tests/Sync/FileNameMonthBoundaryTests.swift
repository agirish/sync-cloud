...
@Suite struct FileNameMonthBoundaryTests {
    ...
    /// all of these as months. `NAPR` is a vendor token that is actually on this tree.
    @Test func anAllCapsRunIsNotAMonthHoweverItEnds() {
        for run in ["KUMAR", "RAJAN", "CODEC", "NAPR", "ACMEDB", "BILLAPR", "BILLSEPTEMBER"] {
    ...
    @Test func anAllCapsNameAndAYearMineNoDate() {
        ...
        #expect(FileNameDate.spelledMonth(in: FileNameDate.tokenRuns("NAPR export 2024")) == nil,
