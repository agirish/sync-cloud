...
@Suite(.serialized) struct LensLaunchGateTests {
    ...
    @Test func lensWorkspaceViewFeedsTheGateToTheLens() throws {
        ...
        // The overview's exception, which is a decision rather than an accident: arriving from a
        // reporting card's "Open Restructure" skips the card, because the pill beside that button
