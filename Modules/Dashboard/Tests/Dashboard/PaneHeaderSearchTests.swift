...
@Suite struct PaneHeaderSearchTests {
    ...
    @Test("The counter comes with buttons to move it", .machinePinned(.pixelSampling))
    ...
    @Test("With no hits the buttons are visibly disabled", .machinePinned(.pixelSampling))
