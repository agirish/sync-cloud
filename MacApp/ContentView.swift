...
struct ContentView: View {
    ...
    ///
    /// The header's path line, the crumb and quick-jump routing, `‹`/`›` and New Folder all turn on
    /// this one question — see `FileSyncManager.paneLocation(isLeft:drawsColumns:)`.
