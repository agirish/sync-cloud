        ...
        Section(title: "Getting started", topics: [
            ...
            Topic(id: "folder-sidebar", title: "The folder sidebar", systemImage: "sidebar.left", article: Article(
                ...
                blocks: [
                    ...
                    .paragraph("Rename a disk or a memory card in Finder and SyncCloud follows it — the source, its pinned folders and its place in Favorites all move to the new name. A card that is merely unplugged is left alone: its row dims until you plug it back in, because a source that is asleep has not gone. Rename one while SyncCloud is closed and it cannot be followed; that is the row “Remove Source…” is for."),
