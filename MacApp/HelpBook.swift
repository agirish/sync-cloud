            ...
            Topic(id: "editor-workspace", title: "Write in a text file", systemImage: "square.and.pencil", article: Article(
                ...
                blocks: [
                    .bullets([
                        ...
                        "A Markdown file gets Source, Preview and Split above it: the text you typed, the rendered document, or both side by side with a divider you can drag. Other text files are always just the text, so the choice is not offered. In Split the preview follows the text as you scroll it.",
                        "⌘F searches the open document when the caret is in it — find, replace, replace all, and a count of the matches as you type. The magnifying glass beside the Source/Preview/Split buttons does the same with the mouse. Anywhere else in SyncCloud ⌘F still finds files in the pane, exactly as it did; it follows the caret rather than the workspace, so ⌘F typed in a pane's own search box is still about files.",
                        "Right-click in the text for a Markup menu: bold, italic, strikethrough, inline code, a link, heading levels, the three kinds of list, a quote, a fenced code block and a horizontal rule. Each one works on what you have selected and takes itself off if you choose it again, and ⌘Z steps back through them like any other edit.",
