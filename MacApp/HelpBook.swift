            ...
            Topic(id: "editor-workspace", title: "Write in a text file", systemImage: "square.and.pencil", article: Article(
                ...
                blocks: [
                    .bullets([
                        ...
                        "Under a Markdown file with headings, the rail grows an Outline. Click a heading to go to it; the one you are in is marked as you move about.",
                        ...
                        "The funnel button at the top of the rail filters the file list by name, for a folder with more files in it than fit.",
