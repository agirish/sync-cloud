            ...
            Topic(id: "editor-workspace", title: "Write in a text file", systemImage: "square.and.pencil", article: Article(
                ...
                blocks: [
                    .bullets([
                        ...
                        "There are four ways to bring a file here, and they all do the same thing. Right-click a text file in Browse, either Compare pane or the columns view and choose Open in Edit, which is the first thing that menu offers. With the preview showing, a text file carries an Edit button by its name — beside it, or under it when the name is long. The Info inspector (⌘I) offers Open in Edit first in its row of actions. And File ▸ Open in Edit does it from the menu bar, on ⌘O, for the one text file selected in the focused pane.",
