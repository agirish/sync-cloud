            ...
            Topic(id: "editor-workspace", title: "Write in a text file", systemImage: "square.and.pencil", article: Article(
                ...
                blocks: [
                    .bullets([
                        ...
                        "A Markdown file gets Source, Preview and Split above it: the text you typed, the rendered document, or both side by side with a divider you can drag. Other text files are always just the text, so the choice is not offered.",
