            ...
            Topic(id: "editor-workspace", title: "Write in a text file", systemImage: "square.and.pencil", article: Article(
                ...
                blocks: [
                    .bullets([
                        ...
                        "There are four ways to bring a file here, and they all do the same thing. Right-click any text file anywhere in SyncCloud — Browse, either Compare pane, the columns view — and choose Open in Edit, which is the first thing that menu offers. With the preview showing, a text file's name line carries an Edit button. The Info inspector (⌘I) offers Open in Edit first in its row of actions. And File ▸ Open in Edit does it from the menu bar, on ⌘O, for whatever the focused pane has selected.",
