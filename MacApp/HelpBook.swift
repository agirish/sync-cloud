            ...
            Topic(id: "editor-workspace", title: "Write in a text file", systemImage: "square.and.pencil", article: Article(
                ...
                blocks: [
                    .bullets([
                        ...
                        "The magnifying glass beside those buttons searches the open document — find, replace, replace all, and a count of the matches as you type. It is the document you are in, not the file list beside it: ⌘F still finds files in the pane.",
