            ...
            Topic(id: "tidy-duplicates", title: "Clear out duplicates", systemImage: "doc.on.doc", article: Article(
                ...
                blocks: [
                    .bullets([
                        ...
                        "1–4 switch how the two sides are shown: side by side, a draggable swipe divider, a blend, or the pixel difference on black where identical is black and anything changed glows. That last one compares pixels with no alignment, so two scans of the same sheet of paper will glow all over — it says so on screen.",
