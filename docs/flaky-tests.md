...
it costs you nothing to notice and everything to miss. **Mechanism 12 is not a flake at all** — it
...
[mechanism 12](#12-the-build-failed-before-any-test-ran) and do not bisect the commit.
...
### 12. The build failed before any test ran
